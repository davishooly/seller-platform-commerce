    ...
    return (
        <>
            ...
            <Box>
                ...
                <p>Note: If you do not see your products category listed below, it may either require approval or be
                    restricted. <a>Click here </a> to learn more.</p>
                ...
                <ButtonContainer list={list}>
                    <Buttons onClick={onNext} style={{width: 200}}> Select </Buttons>
                </ButtonContainer>
                ...
                categoryPage ? <CategoriesSelect
                    ...
                    : (
                        <>
                            ...
                            <p>Complete all the details about your product to improve it’s visibility to buyers across the
                                platform.</p>
                            <Box>
                                <Row gutter={16}>
                                    <Col span={16}>
