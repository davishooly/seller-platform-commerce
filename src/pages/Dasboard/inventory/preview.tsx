    ...
    return (
        <>
                    ...
                    <div>
                        ...
                        <div className="images__container">
                            {formattedFiles.length ? (
                                ...
                                <div
                                    style={{ visibility: files.length ? 'hidden' : 'visible' }}
                                    className="empty__images"
                                >
                                    <Icon
                                        type="file-jpg"
                                        style={{ width: '10em', height: '10em', color: '#08c' }}
                                        theme="outlined"
                                    />
                                ...
                                return (
                                    <Editor
                                        ...
                                        editorState={EditorState.createWithContent(
                                            convertFromRaw(JSON.parse(product[productKey])),
                                        )}
                                    />
                                );
                            }
            ...
            <Action>
                ...
                <Button loading={isPending || submitting} onClick={handleUpload} type="primary">
                    {' '}
                    Submit and Finish{' '}
                </Button>
            </Action>
