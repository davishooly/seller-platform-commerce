...
const Image = ({ callback, score, setScore, files, setFiles }: any) => {
    ...
    return (
        <>
            <p>
                Your images must be atleast 500 x 500 pixels with a maximum of 2000 x 2000 pixels. Individual images
                have a 2mb size limit.
            </p>
            <Container>
                ...
                <Action>
                    ...
                    <Button onClick={() => callback('6')} type="primary">
                        {' '}
                        Preview{' '}
                    </Button>
                </Action>
